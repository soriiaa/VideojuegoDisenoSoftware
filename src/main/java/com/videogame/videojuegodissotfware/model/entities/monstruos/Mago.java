...
public class Mago extends Monstruo {
    public Mago(String nombre, int puntosVida, int vidaMaxima, EstadoEntidad estado, int dano,
    ...
    public Accion decidirAccion() {
        // mago: si tiene más del 50% de vida, ataca (es equilibrado), si no, se protege
        if (this.getPuntosVida() > (this.getVidaMaxima() * 0.5)) {
